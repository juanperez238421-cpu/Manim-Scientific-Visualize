...
SCENE=render_jobs/geometry8_circle_exercises_20260824/Geometry8_Circle_Exercises_Workshop_20260824_V2.py
CLASS=Geometry8CircleExercisesWorkshop20260824V2
...
if [ "$status" -ne 0 ]; then
  ...
  grep -E -B 8 -A 35 'Traceback|ValueError|TypeError|AttributeError|IndexError|KeyError|Exception|ERROR|exceeds|Error' diag/full.log | tail -n 140 || tail -n 140 diag/full.log
