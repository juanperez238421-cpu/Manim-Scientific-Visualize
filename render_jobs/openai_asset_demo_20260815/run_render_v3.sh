...
# Reconstruct exact sources/assets using robust small text chunks.
cat "$JOB"/main_gz_0[0-1] | base64 -d | gzip -dc > main.py
...
# Hard integrity gates before Manim is allowed to run.
echo '05755946c348fb4ca2449b9aa67669caeb6a07c9afe7d855141166472b43fe70  main.py' | sha256sum -c -
